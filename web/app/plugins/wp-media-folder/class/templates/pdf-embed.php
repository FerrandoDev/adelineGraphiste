...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="resource" type="application/l10n" href="<?php echo $plugins_url . 'assets/css/pdf-embed/locale/locale.properties' ?>"><?php // phpcs:ignore ?>
    <script src="<?php echo $plugins_url . 'assets/js/pdf-embed/pdf.js' ?>"></script><?php // phpcs:ignore ?>
    <link rel="stylesheet" href="<?php echo $plugins_url . 'assets/css/pdf-embed/viewer.css' ?>"><?php // phpcs:ignore ?>
    <script type="text/javascript">
      const wpmf_pdf_embed_obj = new Object();
